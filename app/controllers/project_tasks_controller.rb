class ProjectTasksController < ApplicationController
  ...
  private
    ...
    def project_task_params
      params.require(:project_task).permit(:name, :description, :completed, :manager_sign, :client_sign,:manager,:client, schedule_attributes: Schedulable::ScheduleSupport.param_names)
    end
end
